      ...
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
          <div class="max-w-xl lg:max-w-lg">
            <h2 class="text-4xl font-semibold tracking-tight text-white">{{ $t('home.newsletter.title') }}</h2>
            <p class="mt-4 text-lg text-gray-300">{{ $t('home.newsletter.description') }}</p>
            <div class="mt-6">
          ...
          <dl class="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
            <div class="flex flex-col items-start">
              ...
              <dt class="mt-4 text-base font-semibold text-white">{{ $t('home.newsletter.features.weeklyArticles.title') }}</dt>
              <dd class="mt-2 text-base/7 text-gray-400">{{ $t('home.newsletter.features.weeklyArticles.description') }}</dd>
            </div>
            <div class="flex flex-col items-start">
              <div class="rounded-md bg-white/5 p-2 ring-1 ring-white/10">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" data-slot="icon" aria-hidden="true" class="size-6 text-white">
              ...
              <dt class="mt-4 text-base font-semibold text-white">{{ $t('home.newsletter.features.noSpam.title') }}</dt>
              <dd class="mt-2 text-base/7 text-gray-400">{{ $t('home.newsletter.features.noSpam.description') }}</dd>
            </div>
          </dl>
        </div>
      </div>
