...
<template>
  <div>
    <div class="flex items-center justify-between mb-6">
      <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Loyalty Points</h1>
      <button
        type="button"
    ...
    <div class="space-y-6">
      ...
      <div class="bg-white dark:bg-gray-900 rounded-lg p-6">
        <h2 class="font-semibold text-gray-900 dark:text-gray-100 mb-3">How it works</h2>
        <ul class="space-y-2 text-sm text-gray-600 dark:text-gray-400">
          ...
          <li class="flex items-start gap-2">
            ...
            <span>Points become available after order delivery</span>
          </li>
          <li class="flex items-start gap-2">
            ...
            <span>Use points to get discounts on future orders</span>
          </li>
        </ul>
      </div>
